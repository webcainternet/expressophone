							...
							<div class="right col-sm-8">
								...
								<div class="inf">
									...
									<?php if ($product['model']) {?>
										<span class="model">Modelo: <?php echo $product['model']; ?></span>
									<?php }?>
									<span class="prod-stock-2">Disponível:</span>
										
										<?php
										   if ($product['text_availability'] > 0) { ?>
										 <span class="prod-stock">Em estoque</span>
										<?php } else { ?>
											   <span class="prod-stock">Fora de estoque</span>
										 <?php
										 }	
										 ?>
								...
								<div class="clear"></div>
								<div class="rating">
									<img height="18" src="catalog/view/theme/theme419/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
								</div>
							</div>
						</div>
